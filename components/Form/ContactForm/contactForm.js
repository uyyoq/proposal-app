...
const ContactForm = () => {
  return (
    <div className="flex bg-gray-100 w-full md:w-2/4 lg:w-2/4 mx-auto">
      <form className="flex flex-col w-full">
        ...
        <div className="flex items-start flex-col mx-auto my-3 w-2/3">
          ...
          <textarea cols="25" rows="8" className="shadow appearance-none border rounded w-full py-1 px-3 text-sm" id="pesan" type="textarea" placeholder="Pesan Anda"></textarea>
