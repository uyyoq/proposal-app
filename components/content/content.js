  ...
  return (
    <div className="flex flex-col md:flex-row justify-between w-5/6 md:w-3/4 lg:w-5/6 mb-8">
      <div className="flex flex-col text-center md:text-left self-end">
        <motion.h1 className="font-staatliches tracking-widest text-red-600 text-2xl md:text-4xl lg:text-6xl pb-3 font-extrabold"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.p
          className="font-padauk text-red-600 text-sm md:text-md lg:text-lg pb-3 font-bold"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.2 }}
        >
          Hisana menyajikan makanan segar dan lezat. <br />
           daging ayam yang empuk dan kulit ayam crispy</motion.p>
      </div>
